About ergocub-software-feedstock
================================
...
This feedstock builds the following packages:
  ...
  * `ergocub-software` : Meta-package that install all the software provided by the feedstock, i.e. `libergocub-software` and `ergocub-models`.
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ergocub-software-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ergocub-software-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
